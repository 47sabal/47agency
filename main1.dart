...
class _ParkingDashboardState extends State<ParkingDashboard> {
  ...
  // Persistent controller for smooth zooming
      ...
      body: SafeArea(
        child: IndexedStack(
          ...
          children: [
            ...
            const QRTicketScreen(), // Index 2: QR Ticket Screen
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // --- Privacy & Security Description Card ---
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: Colors.white,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Text(
                      'We take data protection seriously. Your personal information, activity history, and authentication details are encrypted and secure. Manage your security credentials below to protect your account from unauthorized access.',
                      style: TextStyle(
                        height: 1.4,
                        fontSize: 13,
                        color: subtitleColor,
